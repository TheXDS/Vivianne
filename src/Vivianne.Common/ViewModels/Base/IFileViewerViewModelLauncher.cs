...
/// <summary>
/// Defines a set of members to be implemented by a type that creates file
/// viewer ViewModels for files with a physical file backing store.
/// </summary>
public interface IFileViewerViewModelLauncher : IViewModelLauncher
{
    /// <summary>
