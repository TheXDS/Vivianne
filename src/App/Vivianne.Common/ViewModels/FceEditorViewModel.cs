...
public class FceEditorViewModel : ViewModel
{
    ...
    {
        broadcastSetup.RegisterPropertyChangeTrigger(() => RenderTree, 
            () => SelectedColorIndex,
            () => SelectedCarTexture);
    }
    ...
    private void OnPartToggle(object instance, PropertyInfo property, PropertyChangeNotificationType notificationType)
    {
        Notify(nameof(RenderTree));
    }
}
