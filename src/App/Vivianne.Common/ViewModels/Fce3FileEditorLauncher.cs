...
/// </summary>
public class Fce3FileEditorLauncher(Func<IDialogService> dialogSvc) : FileEditorViewModelLauncher<FceEditorState, FceFile, FceSerializer, Fce3EditorViewModel>(dialogSvc, "FCE3", FileFilters.FceFileFilter, false)
{
    /// <inheritdoc/>
