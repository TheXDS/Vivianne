    ...
    where TPart : FcePart
{
    ...
    protected static SceneObject CreateShadow(Vector3 modelHalfSize)
    {
        ...
        return new()
        {
            Normals = verts,
            Triangles = [
                new() { I1 = 0, I2 = 2, I3 = 3, Flags = MaterialFlags.NoShading },
                new() { I1 = 0, I2 = 3, I3 = 1, Flags = MaterialFlags.NoShading },
            ],
    ...
    protected static Vector3[] CreateCube(Vector3 size, Vector3 location)
    {
        ...
        [
            ...
            Vector3.FusedMultiplyAdd(new Vector3(-1, -1, -1), size, location),
#else
            /* .NET 8 and earlier did not support hardware-accelerated FMA on
             * vectors, and its syntax is way too long for it to be worth it
             * (it does an FMA per vector component).
             */
    ...
    protected static FceTriangle[] GetCubeTriangles(MaterialFlags material) => [
        new() { I1 = 0, I2 = 1, I3 = 2, Flags = material },
        new() { I1 = 2, I2 = 1, I3 = 3, Flags = material },
        new() { I1 = 5, I2 = 4, I3 = 6, Flags = material },
        new() { I1 = 5, I2 = 6, I3 = 7, Flags = material },
        new() { I1 = 2, I2 = 6, I3 = 4, Flags = material },
        new() { I1 = 0, I2 = 2, I3 = 4, Flags = material },
        new() { I1 = 0, I2 = 4, I3 = 5, Flags = material },
        new() { I1 = 0, I2 = 5, I3 = 1, Flags = material },
        new() { I1 = 2, I2 = 7, I3 = 6, Flags = material },
        new() { I1 = 2, I2 = 3, I3 = 7, Flags = material },
        new() { I1 = 3, I2 = 5, I3 = 7, Flags = material },
        new() { I1 = 1, I2 = 5, I3 = 3, Flags = material },
    ];
    ...
    protected static FceTriangle NormalizeMaterial(FceTriangle triangle) => new()
    {
        ...
        I2 = triangle.I2,
        I3 = triangle.I3,
        Flags = triangle.Flags & MaterialFlags.FceMaterialMask,
